package com.yeminnaing.burpplefoodplace.components;
...
import com.yeminnaing.burpplefoodplace.utils.ScreenUtils;
...
public class PageIndicatorView extends View {
    ...
    private final Paint mPaintNormalFill = new Paint(Paint.ANTI_ALIAS_FLAG);
    private final Paint mPaintSelectFill = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    private void init(Context context) {
        ...
        this.mRadius = ScreenUtils.getInstance().getPixelFromDPI(context, 5);
        this.mPadding = ScreenUtils.getInstance().getPixelFromDPI(context, 5);
    }
